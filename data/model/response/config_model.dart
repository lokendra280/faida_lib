...
class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    // esewa=json['esewa'];
    // khalti=json['khalti'];
    esewa = json['esewa'] != null ? new Esewa.fromJson(json['esewa']) : null;
    khalti =
        json['khalti'] != null ? new Khalti.fromJson(json['khalti']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    // data['esewa']=this.esewa;
    // data['khalti']=this.khalti;
    if (this.esewa != null) {
      data['esewa'] = this.esewa.toJson();
    }
    if (this.khalti != null) {
      data['khalti'] = this.khalti.toJson();
    }
...
class Khalti {
  ...
  Khalti({this.status, this.publicKey});

  Khalti.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Esewa {
  ...
  Esewa({this.status, this.key, this.secret});

  Esewa.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    key = json['key'];
    secret = json['secret'];
  }
