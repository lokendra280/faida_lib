...
class PlaceOrderBody {
  ...
  PlaceOrderBody({
    ...
    @required String esewaresult,
    @required String khaltiresult,
  }) {
    this._cart = cart;
    ...
    this._floor = floor;
    this._dmTips = dmTips;
    this._esewaresult = esewaresult;
    this._khaltiresult = khaltiresult;
  }
  ...
  String get esewaresult => _esewaresult;
  String get khaltiresult => _khaltiresult;
  ...
  PlaceOrderBody.fromJson(Map<String, dynamic> json) {
    ...
    _esewaresult = json['esewaresult'];
    _khaltiresult = json['khaltiresult'];
  }
  ...
  Map<String, String> toJson() {
    ...
    data['esewaresult'] = this._esewaresult;
    data['khaltiresult'] = this._khaltiresult;
    return data;
  }
}
