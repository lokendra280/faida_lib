import 'package:faidanepal/data/model/response/choose_us_model.dart';
import 'package:faidanepal/data/model/response/language_model.dart';
import 'package:faidanepal/util/images.dart';

class AppConstants {
  static const String APP_NAME = 'FaidaNepal';
  static const double APP_VERSION = 1.6;

  static const String BASE_URL = 'https://faidanepal.com/control';
